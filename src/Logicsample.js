...
import { DiagramComponent, SymbolPaletteComponent, SnapConstraints, SnapSettingsModel } from "@syncfusion/ej2-react-diagrams";
...
let diagramInstance;
let nodes = [
    createNode("OR1", 336, 161.5, 70, 80, orData, orPort,"monish"),
...
/* tslint:disable */
let connectors = [
    createConnector("line1", {
        x: 140,
        y: 130
    }, null, null, "OR1", null, "Or_port1", decorator, null, {
        content: "A",
        margin: {
            left: -20
        }
    }, true),
    createConnector("line2", {
        x: 140,
        y: 161.5
    }, null, null, "OR1", null, "Or_port2", decorator, null, {
        content: "B",
        margin: {
            left: -20
        }
    }, true),
    createConnector("line3", {
        x: 140,
        y: 195
    }, null, null, "OR1", null, "Or_port3", decorator, null, {
        content: "C",
        margin: {
            left: -20
        }
    }, true),
    createConnector("line4", {
        x: 85,
        y: 267
    }, null, null, "Not1", null, "Not_port1", decorator, null, {
        content: "A",
        margin: {
            left: -20
        }
    }),
    createConnector("line5", {
        x: 65,
        y: 329
    }, null, null, "Not2", null, "Not_port1", decorator, null, {
        content: "B",
        margin: {
            left: -20
        }
    }),
    createConnector("line6", {
        x: 85,
        y: 470
    }, null, null, "Not3", null, "Not_port1", decorator, null, {
        content: "C",
        margin: {
            left: -20
        }
    }),
    createConnector("line7", null, null, "Not1", "OR2", "Not_port2", "Or_port1", null, null, {
        content: "A'",
        margin: {
            left: 0,
            top: -20
    ...
    createConnector("line8", null, null, "Not2", "OR2", "Not_port2", "Or_port2", null, null, {
        content: "B'",
        margin: {
            left: 0,
            top: -20
    ...
    createConnector("line9", {
        x: 140,
        y: 380
    }, null, null, "OR2", null, "Or_port3", decorator, null, {}, true),
    createConnector("line10", {
        x: 140,
        y: 420
    }, null, null, "OR3", null, "Or_port1", decorator, null, {}, true),
    createConnector("line11", null, null, "Not3", "OR3", "Not_port2", "Or_port2", null, null, {
        content: "B'",
        margin: {
            left: 0,
            top: -20
    ...
    createConnector("line12", {
        x: 140,
        y: 520
    }, null, null, "OR3", null, "Or_port3", decorator, null, {}, true),
    createConnector("line13", null, null, "OR1", "And", "Or_port4", "And_port1", null, null, {
        content: "(A + B + C)",
        margin: {
            left: 0,
            top: -20
    ...
    createConnector("line14", null, null, "OR2", "And", "Or_port4", "And_port2", null, null, {
        content: "(A' + B' + C)",
        margin: {
            left: 0,
            top: -20
    ...
    createConnector("line15", null, null, "OR3", "And", "Or_port4", "And_port3", null, null, {
        content: "(A + B' + C)",
        margin: {
            left: 0,
            top: -20
    ...
    createConnector("line16", null, {
        x: 600,
        y: 329
    }, "And", null, "And_port4", null, null, decorator, {
        content: "F =(A+B+C)*(A+B'+C)*(A+B'+C)",
        margin: {
            left: -80,
            top: 60
        }
...
let items = [
    ...
    },
    {
        ...
        shape: {
            type: 'Path',
            data: 'M21.7,76.5L21.7,76.5c6.4-18.1,6.4-37.8,0-55.9l0-0.1h1.6c21.5,0,41.7,10.4,54.2,28l0,0l0,0  c-12.5,17.6-32.7,28-54.2,28H21.7z M83.5,48.5h16 M1.5,32.5h24 M1.5,64.5h24 M80.5,45.5c-1.7,0-3,1.3-3,3s1.3,3,3,3s3-1.3,3-3  S82.2,45.5,80.5,45.5z'
        }
    },
    {
        id: 'And',
    ...
    },
    {
        ...
        shape: {
            type: 'Path',
            data: 'M49.5,76.5h-28v-56h28c15.5,0,28,12.5,28,28v0C77.5,64,65,76.5,49.5,76.5z M83.5,48.5h16 M1.5,32.5h20   M1.5,65.5h20 M80.5,45.5c-1.7,0-3,1.3-3,3s1.3,3,3,3s3-1.3,3-3S82.2,45.5,80.5,45.5z'
        }
    }, {
        id: 'not',
        shape: {
...
export default function LogicCircuit() {
    ...
    const [gridpoperties, setGridproperties] = useState({
        showgrid: true,
        gridcolor: "#444444",
        hspace: 10,
        vspace: 10,
...
const [dotspace, setDotspace] = useState(20);
const [dotsize, setDotsize] = useState(0.7);
const [color, setColor] = useState({gridcolor: 'grey'});
    interval = [
    ...
    let gridlines = {
        lineColor: gridpoperties.gridcolor,
        lineIntervals: [
            9, 20
        ],
        // horizontalGridlines:[20,1.2]
        lineDashArray: "2 1"
    ...
    let hgridlines = {
        ...
        lineColor: gridpoperties.gridcolor,
        lineIntervals: vinterval,
        strokeWidth: 13,
        interval: 94
    };
    // let snapSettings = {
    //     constraints: SnapConstraints.ShowLines,
    //     horizontalGridlines: hgridlines,
    //     verticalGridlines: vgridlines
    // };
    ...
    return (
        <div className="control-pane">
            ...
            <div className="control-section">
                ...
                <ToolbarComponent id="toolbar_diagram"
                    style={
                        {
                            width: "100%",
                            height: "10%",
                    ...
                    clicked={
                        (args) => {
                            ...
                            // else if (args.item.prefixIcon == 'e-diagram-icons e-diagram-save') {} else {
                    ...
                    items={
                        [
                            ...
                            },
                            {
                                ...
                                text: curfilename,
                                tooltipText: () => curfilename,
                                prefixIcon: "e-filename"
                            }
                        ]
                    } />
              ...
              <label>
                ...
                <input
                  ...
                  name="name"
                  style={{ width: "40px" }}
                  onChange={(e) => setDotspace(e.target.value)}
                />
              </label>
              <label style={{float: 'left', paddingLeft : '27px'}}>
                Color :
              <input
                type="color"
                style={{width: '43px'}}
                value ={color.gridcolor}
                onChange={(e) =>
                  setColor((current) => {
                    return { ...current, gridcolor: e.target.value };
                  })
                }
              ></input>
              </label>
                        ...
                        <SymbolPaletteComponent id="symbolpalette" expandMode="Multiple"
                            ref={
                                (symbolpalette) => (symbolPaletteInstance = symbolpalette)
                            }
                            palettes={
                                [
                                    {
                        ...
                        <input type="number"
                            onChange={
                                e => setlinewidth(e.target.value)
                            }></input>
                        <input type="color"
                            onChange={
                                e => setGridproperties((current)=>{return{...current,gridcolor:e.target.value}})
                            }></input>
                        <div id="dropArea">
                            <ButtonComponent ref={
                                (browse) => (buttonInstance = browse)
                            }
                                onClick={
                                    e => btnClick()
                                }
                            ...
                            <UploaderComponent id="uploadFiles" type="file"
                                ref={
                                    (uploadFiles) => (uploadBoxInstance = uploadFiles)
                                }
                                asyncSettings={
                                    {
                    ...
                    <div id="diagram-space" className="sb-mobile-diagram">
                        <DiagramComponent id="diagram"
                            ...
                            onChange={e=>alert("new")}
                            onUserHandleMouseUp={e=>alert("new")}
                            width={"100%"}
                            height={"100%"}
                            // rulerSettings={
                            //     { showRulers: true }
                    ...
                    <div>
            {/* <button onClick={() => setModalIsOpen(!modalIsOpen)}>click</button> */}
            ...
            >
              {(interpolatedStyle) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <span>menuitem</span>
                          ...
                          <hr></hr>
                          <Row style={{flex:true,backgroundColor:""}}>
                        {/* <hr></hr> */}
                        {/* <br></br> */}
                        <span  style={{float:"left"}}>
                          <label onClick={() => setModalIsOpen(true)}>
                            grid options
                          </label>
                        </span>
                          </Row>
                ...
                <div> {/* <input type="number"> </input>line width */} </div>
            </div>
           
{/* <div style={{background:"red",height:"40px",width:"40px"}}></div> */}
{modalIsOpen && (
              <Draggable >
                <div
                  style={{
                ...
                >
                  ...
                  <input
                    type="checkbox"
                    defaultChecked={gridpoperties.showgrid}
                    onChange={() =>
                      setGridproperties((current) => {
                        return { ...current, showgrid: !current.showgrid };
                      })
                    }
                  ></input>{" "}
                  Show grid
                  ...
                  <input
                    type="number"
                    width="4"
                    value={gridpoperties.hspace}
                    min={1}
                    onChange={(e) =>
                      setGridproperties((current) => {
                        return { ...current, hspace: e.target.value };
                      })
                    }
                  ></input>
                  inches
                  ...
                  <input
                    type="number"
                    width="4"
                    value={gridpoperties.vspace}
                    min={1}
                    onChange={(e) =>
                      setGridproperties((current) => {
                        return { ...current, vspace: e.target.value };
                      })
                    }
                  ></input>
                  inches
    ...
    function onUploadSuccess(args) {
        ...
        // alert(file1.name)
        setcurfilename(file1.name.toString())
        console.log(curfilename)
        // localStorage.setItem("curfilename", file1.name.toString())
...
function createNode(id, offsetX, offsetY, height, width, pathData, ports,content) { // update node properties
    let node = {};
    node.id = id;
...
function createConnector(id, sourcePoint, targetPoint, sourceID, targetID, sourcePortID, targetPortID, sourceDecorator, targetDecorator, annotation, segments, isStraight) { // update connector properties
    let connector = {};
    connector.id = id;
